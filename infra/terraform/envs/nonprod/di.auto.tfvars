...
#   pool-np-general          2        30          27/s  -> pool-overflow-general
#   pool-np-critical         3        45          40/s  -> pool-overflow-critical
...
di_cells = {
  "np-general" = {
    zone = "general"
    members = {
      "di-np-gen-1" = { weight = 1, tps = 15 }
      "di-np-gen-2" = { weight = 1, tps = 15 }
    }
  }
  "np-critical" = {
    zone = "critical"
    members = {
      "di-np-crit-1" = { weight = 1, tps = 15 }
      "di-np-crit-2" = { weight = 1, tps = 15 }
      "di-np-crit-3" = { weight = 1, tps = 15 } # after a TPS increase: tps = 45, weight = 3
    }
  }
}
...
di_overflow = {
  general = {
    "di-np-ovf-gen-1" = { weight = 1, tps = 15 }
  }
  critical = {
    "di-np-ovf-crit-1" = { weight = 1, tps = 15 }
  }
}
...
# overflow = false.
di_tenants = {
  "3f1c0d8e-0000-0000-0000-000000000001" = { cell = "np-general", tier = "standard", overflow = true, modelPrefix = "t001-" }
  "3f1c0d8e-0000-0000-0000-000000000002" = { cell = "np-general", tier = "standard", overflow = true, modelPrefix = "t002-" }
  "3f1c0d8e-0000-0000-0000-000000000003" = { cell = "np-general", tier = "gold", overflow = true, modelPrefix = "t003-" }
  "3f1c0d8e-0000-0000-0000-000000000101" = { cell = "np-critical", tier = "gold", overflow = true, modelPrefix = "t101-" }
  "3f1c0d8e-0000-0000-0000-000000000102" = { cell = "np-critical", tier = "gold", overflow = true, modelPrefix = "t102-" }
}
